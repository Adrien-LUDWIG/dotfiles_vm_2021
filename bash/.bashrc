...
if ${use_color} ; then
	...
	if [[ ${EUID} == 0 ]] ; then
		PS1='\[\033[01;31m\][root\h\[\033[01;36m\] \W\[\033[01;31m\]]\$\[\033[00m\] '
	else
        PS1="\[\e[30;1m\](\[\e[35;1m\]\t\[\e[30;1m\])-(\[\[\e[36;1m\]\!\[\e[30;1m\])-(\[\e[33m\]\j\[\e[30;1m\])-(\[\e[34;1m\]\w\[\e[30;1m\])\n(\`if [ \$? = 0 ]; then echo \[\e[32m\]^_^\[\e[30m\]; else echo \[\e[31m\]O_o\[\e[30m\]; fi\`) \[\e[0m\]"
	fi
